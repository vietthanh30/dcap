...
namespace web_app.admin
{
    public partial class TraCuuThanhVien : System.Web.UI.Page
    {
        ...
        private void LoadUserInfo(UserDto[] userDtos)
        {
            ...
            {
                index++;
                lblMemberInfo.Text += "<tr>";
                lblMemberInfo.Text += "<td>" + index + "</td>";
                lblMemberInfo.Text += "<td>" + dto.FullName + "</td>";
                lblMemberInfo.Text += "<td>" + dto.SoCmnd + "</td>";
                lblMemberInfo.Text += "<td>" + dto.AccountNumber + "</td>";
                lblMemberInfo.Text += "<td>" + dto.UserName + "</td>";
                lblMemberInfo.Text += "</tr>";
            }
