...
{
    public partial class ManagerNetwork : System.Web.UI.Page
    {
        ...
        protected void ManagerNetwork_SearchNetwork(object sender, EventArgs e)
        {
            OnSearchNetwork();
        }
        ...
        private void OnSearchNetwork()
        {
            ...
            var allMemberNodeDto = DcapServiceUtil.SearchManagerNodeDto(capQuanLy, idMember);
